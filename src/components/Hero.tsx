...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[70vh] lg:min-h-[80vh] bg-cover bg-center bg-no-repeat flex items-center before:absolute before:inset-0 before:bg-black/20 before:z-0" style={{backgroundImage: "url('/lovable-uploads/a5794871-61ac-48eb-b0bf-669c4e654044.png')"}}>
