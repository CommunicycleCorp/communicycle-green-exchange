          ...
          <div className="space-y-4 lg:space-y-8">
            <div className="space-y-2 lg:space-y-4">
              ...
              <p className="text-base md:text-xl text-white/90 leading-relaxed font-medium">
                <strong className="text-white text-xl md:text-2xl lg:text-2xl font-extrabold">Turn Old Electronics Into Cash with ITAD Asset Recovery:</strong> Get Paid for Your Laptop, Computer, or Phone — Fast, Secure, and Guaranteed in 14 Days or Less, or We Pay You $100.
              </p>
              ...
              <p className="text-base md:text-xl text-white/90 leading-relaxed font-medium">
                <strong className="text-white text-xl md:text-2xl lg:text-2xl font-extrabold">End-of-Life Electronic Recycling:</strong> Find the nearest Communicycle bin and support your local collector. Recycle your end-of-life electronics responsibly and help protect the environment by keeping e-waste out of landfills.
              </p>
            </div>
