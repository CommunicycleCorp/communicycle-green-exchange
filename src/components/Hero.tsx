          ...
          <div className="space-y-1 lg:space-y-4">
            <div className="space-y-6 lg:space-y-3">
              ...
              <p className="text-xl md:text-3xl text-white font-semibold md:font-medium leading-tight mt-4 md:mt-0 drop-shadow-lg">
                <span className="hidden md:inline">Get Paid <span className="text-4xl md:text-5xl font-bold">BIG</span> for Your Electronics - </span><span className="md:hidden">Get Paid Big for Your Laptop, Computer, or Phone — Fast, Secure, and Guaranteed in 14 Days or Less, or We Pay You $100.</span><span className="hidden md:inline">Get Paid Big for Your Laptop, Computer, or Phone — Fast, Secure, and Guaranteed in 14 Days or Less.</span>
              </p>
