...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] sm:min-h-[55vh] lg:min-h-[65vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-5 py-2 md:py-7 lg:py-10 lg:ml-0 lg:max-w-none lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-3 lg:gap-8 items-center">
          ...
          <div className="space-y-1 lg:space-y-4">
            <div className="space-y-6 lg:space-y-3">
              ...
              <p className="text-xl md:text-3xl text-white font-medium leading-tight mt-4 md:mt-0 drop-shadow-lg">
