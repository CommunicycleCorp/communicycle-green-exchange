          ...
          <div className="space-y-4 lg:space-y-8">
            <div className="space-y-2 lg:space-y-4">
              ...
              <p className="text-base md:text-xl text-white/90 leading-relaxed">
                <strong className="text-white text-xl md:text-2xl lg:text-xl">Turn Old Electronics Into Cash with ITAD Asset Recovery:</strong> We take your electronics and turn them into cash. Whether you're a household or a business, we refurbish your devices, increase their value, then our specialized team handles the resale and returns the majority of the profits to you. It's fast, easy, and built to maximize your payout.
              </p>
              ...
              <p className="text-base md:text-xl text-white/90 leading-relaxed">
                <strong className="text-white text-xl md:text-2xl lg:text-xl">End-of-Life Electronic Recycling:</strong> Find the closest Communicycle bin to you and support your local collector and the environment by diverting all your electronic waste from reaching the landfill; Skip the landfill with Communicycle.
              </p>
            </div>
