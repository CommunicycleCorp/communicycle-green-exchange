        ...
        <div className="grid lg:grid-cols-2 gap-3 lg:gap-8 items-center">
          ...
          <div className="space-y-1 lg:space-y-4">
            <div className="space-y-6 lg:space-y-3">
              ...
              <p className="text-base md:text-xl lg:text-2xl text-white/95 leading-relaxed font-semibold">
                <strong className="text-white text-xl md:text-2xl lg:text-3xl font-bold">End-of-Life Electronic Recycling:</strong> Find the nearest Communicycle bin. Recycle your end-of-life electronics responsibly and help protect the environment by keeping e-waste out of landfills.
              </p>
            </div>
